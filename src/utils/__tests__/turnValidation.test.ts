...
import { areAllPlacementsInSameLine, isPlacementInSameLineAsPending } from "../turnValidation"
...
describe("areAllPlacementsInSameLine", () => {
  ...
  it("returns true for single placement", () => {
    expect(areAllPlacementsInSameLine([pending(card(1, "red", "triangle"), 0, 0)])).toBe(true)
  })
