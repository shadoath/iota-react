      ...
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        {loading ? (
          ...
          <>
            ...
            <h3 className={styles.title}>Sign In Coming Soon</h3>
            <p className={styles.subtitle}>
              Account sign-in is being configured. Your stats and achievements are safely stored
              locally and will sync to your account once ready.
            </p>
          </>
        ) : isAuthenticated ? (
          <>
            ...
            <div className={styles.profile}>
              ...
              <div className={styles.profileInfo}>
                <div className={styles.profileName}>{displayName ?? "Player"}</div>
          ...
          <>
            ...
            <button type="button" className={styles.providerBtn} onClick={signInWithGithub}>
              <span className={styles.providerIcon}>
