...
export const ACHIEVEMENTS: Achievement[] = [
  // Beginner
  { id: 'first_game', name: 'First Steps', description: 'Complete your first game', icon: '\u{1F3AF}' },
  { id: 'first_win', name: 'Winner', description: 'Win your first game', icon: '\u{1F3C6}' },
  { id: 'tutorial_complete', name: 'Student', description: 'Complete the tutorial', icon: '\u{1F393}' },

  // Skill
  { id: 'four_of_a_kind', name: 'Four of a Kind', description: 'Play all 4 cards in a single turn', icon: '\u{1F0CF}' },
  { id: 'century', name: 'Century', description: 'Score 100+ in a single game', icon: '\u{1F4AF}' },
  { id: 'perfect_line', name: 'Perfect Line', description: 'Score 16 in a single turn (4+4+4+4)', icon: '\u2B50' },
  { id: 'high_roller', name: 'High Roller', description: 'Score 10+ in a single turn', icon: '\u{1F3B2}' },
  ...
  // Modes
  { id: 'practice_player', name: 'Learner', description: 'Complete a practice mode game', icon: '\u{1F4D6}' },
