    ...
    <div className={styles.container}>
      <div className={styles.inner}>
        ...
        <div className={styles.content}>
          ...
          <h2>Agreement</h2>
          <p>
            By accessing or playing NodusNexus (&quot;the game&quot;, &quot;the service&quot;), you agree to
            these Terms of Service. If you do not agree, please do not use the service.
          </p>

          <h2>Description of Service</h2>
          <p>
            NodusNexus is a free-to-play digital card game available via web browser.
            The game includes single-player modes against AI opponents, multiplayer modes
            for playing with other users, and various practice and training features.
          </p>
          ...
          <p>
            The NodusNexus name, logo, game design, and all associated content are the
            property of the NodusNexus team. The game&apos;s source code is available under
            the MIT License.
          </p>

          <h2>Accounts</h2>
          <p>
            NodusNexus can be played without an account. If you choose to create an account,
            you are responsible for maintaining the security of your credentials. We are not
            liable for any loss resulting from unauthorized use of your account.
          </p>

          <h2>Availability</h2>
          <p>
            We strive to keep NodusNexus available at all times but do not guarantee
          ...
          <p>
            ...
            limited to loss of data, loss of game progress, or interruption of service.
          </p>

          <h2>Modifications</h2>
          <p>
            We reserve the right to modify the game, its features, or these terms at any
          ...
          <h2>Termination</h2>
          <p>
            We may suspend or terminate access to the service for users who violate these
